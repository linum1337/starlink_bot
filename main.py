...
def plan(message):
    if message.text == 'Текущий тариф':
        ...
        print(services_parsed)
        bot.send_message(message.from_user.id, f'Текущий тариф: {services_parsed}', reply_markup=keyboard)
...
def balance(message):
    if message.text == 'Текущий баланс':
        ...
        print(services_parsed)
        bot.send_message(message.from_user.id, f'Текущий баланс: {services_parsed} руб.', reply_markup=keyboard)
